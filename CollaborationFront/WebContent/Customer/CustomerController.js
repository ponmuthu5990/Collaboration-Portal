...
app.controller('CustomerController',function(CustomerService,$scope,$location,$rootScope,$cookieStore){
	...
	$scope.signUp=function(){
		CustomerService.signUp($scope.customer).then(function(response) {
	...
	$scope.signIn=function(){
		...
		if($scope.customer.userName != null && $scope.customer.password == null){
			...
			CustomerService.signIn($scope.customer).then(function(response) {
		...
		if($scope.customer.userName != null && $scope.customer.password != null){
			...
			if($rootScope.customer.password == $scope.customer.password){
				...
				CustomerService.checkPassword($rootScope.customer).then(function(response) {
